...
private:
    ...
    static std::string buildRedirect(int code, const std::string& statusText, const std::string& location);
    static std::string getRootDir(const ServerConfig* serverConfig);
